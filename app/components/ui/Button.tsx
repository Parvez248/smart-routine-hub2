...
// Solid accent fill — no gradients. Buttons never print (Step 24).
const PRIMARY_EXTRA = "print:hidden";
...
export function Button({
  ...
  return (
    <ShadcnButton
      ...
      className={cn("h-9 px-6 text-sm font-medium gap-2", variant === "primary" && PRIMARY_EXTRA, className)}
      {...props}
    >
