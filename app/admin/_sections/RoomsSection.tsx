        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              <label htmlFor="room-name" className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="room-capacity" className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                Capacity <span className="text-cancelled">*</span>
              </label>
              <input
                id="room-capacity"
                type="number"
