        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              <label htmlFor="teacher-initials" className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                Initials <span className="text-cancelled">*</span>
              </label>
              <input
                id="teacher-initials"
                type="text"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="teacher-name" className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
